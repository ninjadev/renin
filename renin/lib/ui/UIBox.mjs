import { BufferGeometry, BufferAttribute, BoxBufferGeometry, Object3D, MeshBasicMaterial, Mesh, ShaderMaterial } from 'three';
import { defaultVertexShader } from '../renin.mjs';
import shadowShader from './shadowShader.mjs';

const roundedRectangleCache = {};
/* Adapted from https://discourse.threejs.org/t/roundedrectangle/28645 */
function makeRoundedRectangleBufferGeometry(width, height, radiusX, radiusY, smoothness) {
...
class UIBox {
    ...
    constructor(options) {
        ...
        this.shadow = new Mesh(geometry, new ShaderMaterial({
    ...
    setTexture(texture, needsUpdate = false) {
        //@ts-ignore
...
export { UIBox, makeRoundedRectangleBufferGeometry };
