...
void main() {
    ...
    vec3 beatColor = mix(slate_400, slate_500, step(1., mod(vUv.x * width, width / beats * 4.)));
    ...
    color = mix(color, beatColor, float(0x88) / 255. * (1. - step(1., mod(vUv.x * width, width / beats))));
